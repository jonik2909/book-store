...
import 'package:book_store/pages/admin/create_product.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              _buildRouterTile(context, 'Products', Icons.store, Products()),
              _buildRouterTile(context, 'Create New Product', Icons.add_box,
                  CreateProduct()),
